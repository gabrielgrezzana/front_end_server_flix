  ...
  return (
    <Style.Form>
      <Style.FormCard onSubmit={handleSubmit}>
        <Style.titles>Série</Style.titles>
        <Style.InputCard type="text" placeholder="titulo da série" name="gameTitle" />
        <Style.InputCard type="text" placeholder="descrição da série" name="description" />
        <Style.InputCard type="number" placeholder="avaliação da série" name="avaliation" />
        <Style.InputCard type="text" placeholder="URL da imagem da série" name="image" />
