  ...
  return (
    <Style.Form>
      <Style.FormCard onSubmit={handleSubmit}>
        <Style.titles>Anime</Style.titles>
        <Style.InputCard type="text" placeholder="titulo do anime" name="gameTitle" />
        <Style.InputCard type="text" placeholder="descrição do anime" name="description" />
        <Style.InputCard type="number" placeholder="avaliação do anime" name="avaliation" />
        <Style.InputCard type="text" placeholder="URL da imagem do anime" name="image" />
